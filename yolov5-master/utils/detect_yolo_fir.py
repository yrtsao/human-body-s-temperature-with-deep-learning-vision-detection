# -*- coding: utf-8 -*-
"""
Created on Mon Feb  1 11:37:52 2021

@author: LU
"""
import sys
sys.path.append('D:\python\yolov5_notebook\yolov5-master\yolov5-master')
# sys.path.append('D:\picture_fiting\yolov5-master\yolov5-master')
...
class detect_yolo:
    def __init__(self):
        ...
        # self.model = hub.custom(path_or_model=r'D:\picture_fiting\yolov5-master\yolov5-master\yolov5s.pt') 
...
if __name__ == '__main__':
    isstop = True
    # M = np.load('./transform/415-5/M.npy')
    M = np.load('M.npy')
